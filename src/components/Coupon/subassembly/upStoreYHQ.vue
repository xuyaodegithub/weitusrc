<template>
  <div id="smalltitle">
    <p id="toindex">
      ...
      <el-button type="success" round size="mini" icon="el-icon-plus" @click="StoreChange('VStorecoupon')" style="margin-top: 10px">新增优惠券</el-button>
      <el-button type="success" size="mini" round style="margin-top: 10px" @click="StoreChange('VseachStoreCoupon')" v-if="StoreYHQResult !== 'VseachStoreCoupon'">返回</el-button>
    </p>
    <div class="logo-list">
    ...
    <div class="footer-list">
      <keep-alive>
        <component :is="StoreYHQResult"></component>
      </keep-alive>
    </div>
  </div>
...
export default {
  ...
  computed:{
    ...mapGetters([
     'popoverAlive','StoreYHQResult'
    ])
  },
  components:{
    VStorecoupon,VupDataStoreCoupon,VseachStoreCoupon
  },
  methods: {
    ...mapActions([
    ...
    StoreChange(str){
      this.$store.commit('SET_STORE_YHQ',str)
    }
